...
class TransactionService
{
  ...
  public function createTransaction(array $data)
  {
    return DB::transaction(function () use ($data) {
      ...
      // Checking authorization merchant and keeper
      ...
      foreach ($data["products"] as $productData) {
        ...
        $merchantProduct = $this->merchantProductRepository->getByMerchantAndProduct($data["merchant_id"], $productData["product_id"]);

        // checking merchant product exist and stock available
        ...
        // Update stock in merchant product
