    ...
    <div id="main-container" className="lg:flex flex-1">
      ...
      >
        ...
        <main className="flex flex-col gap-6 flex-1 ">
          <section
            id="Merchant-Info"
            className="flex items-center justify-between rounded-3xl p-[18px] gap-3 bg-white flex-col sm:flex-row"
          >
          ...
          <section
            id="Products"
            className="flex flex-col gap-6 rounded-3xl p-[18px] px-0 w-full"
          >
            <div className="flex gap-6 flex-col xl:flex-row w-full ">
              <div className="flex flex-col w-full h-fit rounded-3xl p-[18px] gap-5 bg-white">
                ...
                {transaction.transaction_products.map((item, index) => (
                  <div
                    key={index}
                  ...
                  >
                    <div className="flex items-center justify-between gap-6 flex-col sm:flex-row ">
                      ...
                      <div className="hidden md:flex items-center gap-[6px] w-fit shrink-0 ">
                        <img
                          src={
                            item.product.category?.photo ||
                            "/assets/images/icons/Makeup-black.svg"
                          }
                          className="size-6 flex shrink-0"
                          alt="icon"
                        />
                  ...
                  <div className="flex flex-col gap-5">
                    ...
                    <div className="flex items-center justify-between gap-3 rounded-2xl border border-monday-border p-4  ">
                      <div className="flex flex-col gap-2 flex-1 md:w-full ">
                        ...
                        <p className="flex items-center gap-1 font-medium text-base sm:text-lg text-monday-gray">
                          <img
                            src="/assets/images/icons/call-grey.svg"
                            className="size-5 sm:size-6 flex shrink-0"
                            alt="icon"
                      ...
                      <div className="flex size-[56px] rounded-2xl bg-monday-background items-center justify-center overflow-hidden shrink-0">
                        <img
                  ...
                  <div className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col w-full items-center justify-between gap-5 rounded-2xl border border-monday-border p-4">
                      <div className="flex w-full items-center justify-between flex-row gap-2">
                        ...
                        <p className="font-semibold text-base sm:text-lg">
                          {transaction.transaction_products.length}{" "}
                          {transaction.transaction_products.length === 1
                            ? "Item"
                            : "Items"}
                        </p>
                      </div>
                      ...
                      <div className="flex w-full items-center justify-between flex-col sm:flex-row gap-2">
                        <p className="flex items-center gap-1 font-medium text-monday-gray">
                          <img
                        ...
                        <p className="font-semibold text-lg sm:text-xl text-monday-blue">
