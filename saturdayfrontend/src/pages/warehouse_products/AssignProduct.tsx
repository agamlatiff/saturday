        ...
        >
          <div className="flex items-center gap-6 h-[92px] bg-white w-full rounded-3xl p-[18px]">
            <div className="flex flex-col gap-[6px] w-full">
              <h1 className="font-bold text-lg sm:text-2xl">Assign New Product</h1>
              <Link
              ...
              <ul className="flex flex-col gap-4">
                <li className="flex gap-[6px]">
                  ...
                  <p className="font-medium leading-[140%]">
                    Use clear, high-resolution product images to ensure accurate
                    identification.
                  </p>
                </li>
                ...
                <li className="flex gap-[6px]">
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Confirm the product SKU and name are correct and match
                    inventory records.
                  </p>
                </li>
                ...
                <li className="flex gap-[6px]">
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Select the appropriate warehouse and verify the assigned
                    stock quantity.
                  </p>
                </li>
                ...
                <li className="flex gap-[6px]">
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Ensure uploaded images are under 2MB and comply with format
                    requirements.
                  </p>
                </li>
                ...
                <li className="flex gap-[6px]">
                  ...
                  />
                  <p className="font-medium leading-[140%]">
                    Review all assignment details for accuracy before saving to
